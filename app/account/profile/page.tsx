...
export default async function ProfilePage() {
  ...
  return <div className="min-w-0"><h1 className="text-2xl font-bold sm:text-3xl">Profile</h1><p className="mb-6 mt-2 text-sm text-muted-foreground sm:mb-8 sm:text-base">Keep your contact information up to date.</p><ProfileForm profile={profile} email={user.email ?? ""} /></div>
}
